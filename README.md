...
To prevent there just being an awkward blank section in the middle, the side LEDs have been split into a separate board, which will be connected to the main board via some wiring. By adding headers, and with a small case redesign, you could connect them even more easily (and... hotswappably?)
...
- [8x SK6803MINI-E](https://www.aliexpress.us/item/3256807898532204.html)
  - Kicad schematics show SK6812MINI-E because I couldn't find any schematics for the former and didn't want to make my own symbol/rename it, but either works. **See [notes](#notes) for important details.**
